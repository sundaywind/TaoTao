 ...
 * Generated at: 2019-08-28 06:58:07 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t// 页面初始化的时候，调用URL来初始化ID为contentCategory的树形图\r\n");
      out.write("\t\turl : '/content/category/list', // 首先返回一个JSON数据。格式为：ID、text、status。第一次访问的时候先打开parentId为0的，文件夹关闭，打开后传ID去请求第二级，根据parentId为0，依次类推。\r\n");
      ...
      out.write("        \tif(node.id == 0){ // 如果节点是0，这个0（行号：57）不是数据库的0，而是用来判断新增和修改的。\r\n");
      out.write("        \t\t// 新增节点       URL\t\t\t   parentId               name\r\n");
